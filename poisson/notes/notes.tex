...
(by writing $\matr{A} = \matr{D} + \matr{T}$, where $\matr{D}$ is diagonal):
\begin{eqnarray}
\vect{f} &=& \matr{A}\vect{v} = \matr{D}\vect{v} + \matr{T}\vect{v} \\
\matr{D}\vect{v} &=& \vect{f} - \matr{T}\vect{v} = \vect{f} - \matr{A}\vect{v} + \matr{D}\vect{v} \\
