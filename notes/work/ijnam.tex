...
\title{Numerical and analytical solution of nonlinear electro-kinetic phenomena}
...
\abstract{A numerical solver for the simulation of ion-exchanging particles migration in an
