...
Far away from the particle, we have uniform flow, uniform electrostatic field
...
and conductance of the particle:
\begin{eqnarray}
\bv & = & \bzero, \\
\bn \cdot \bj_- & = & 0, \\
c_+ & = & \gamma, \\
...
The Stokes flow equations have the same form as microscale equations:
\begin{eqnarray}
\bnabla \cdot \bV &=& 0, \\
\Laplacian \bV - \bnabla P + \bnabla \varPhi \Laplacian \varPhi &=& 0.
\end{eqnarray}
