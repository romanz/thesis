...
has been used to derive nonlinear effective boundary conditions 
...
constructed automatically from the discrete equations and the 
nonlinear effective boundary conditions.
...
nano-fluidic devices, packed bed separation, desalination processes 
and various electrophoresis applications \cite{howse2007self,paxton2004catalytic,pumera2010electrochemically,nischang2007,leinweber2004}.
...
The paper is structured as follows: the governing equations of 
the electrokinetic model are presented in Section \ref{sec:equations}, 
following the derivation at \cite{yariv2010migration, schnitzer2012surface}. 
The algorithm for the discretization and 
the solution of the system is described in Section \ref{sec:algorithm}.
An analytical asymptotic solution for the ion exchanger nonlinear 
macroscale model is derived and presented in Section \ref{sec:asymp}.
...
\begin{figure}[htbp]
    \begin{center}
	\includegraphics[width=0.45\textwidth]{figs/Cubic/Stream/N1.eps}
	\includegraphics[width=0.45\textwidth]{figs/Cubic/Stream/A1.eps}
	\includegraphics[width=0.45\textwidth]{figs/Cubic/Stream/N2.eps}
	\includegraphics[width=0.45\textwidth]{figs/Cubic/Stream/A2.eps}
	\includegraphics[width=0.45\textwidth]{figs/Cubic/Stream/N5.eps}
	\includegraphics[width=0.45\textwidth]{figs/Cubic/Stream/A5.eps}
	\includegraphics[width=0.45\textwidth]{figs/Cubic/Stream/N10.eps}
	\includegraphics[width=0.45\textwidth]{figs/Cubic/Stream/A10.eps}
