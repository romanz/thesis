...
potential $\varPhi$, fluid's velocity $\bV$ and its pressure $P$
and ionic concentration $C$.
...
drug-delivery systems and useful nanomachinery \cite{Pumera10}.
...
one-dimensional root-finding algorithm (e.g. the secant method) 
on $F_\beta(\cl{U})$, as a function of $\cl{U}$.
