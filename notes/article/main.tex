...
\begin{abstract}
A numerical solver for the simulation of ion-exchanging particles migration in an
...
\begin{keyword}
CFD \sep electrokinetics \sep asymptotics
\end{keyword}
...
One such phenomenon is nonlinear electrokinetic vortex flow (as shown in Figure \ref{fig:Granule}), 
which can useful for microfluidic mixing applications \cite{wang2004mix, ben2002vortex},

\begin{figure}[htbp]
    \begin{center}
        \includegraphics[width=0.4\textwidth]
            {figs/vortex.eps}
        \caption{A micro-vortex electrokinetic flow around a 1 mm spherical ion-exchanger granule. }
        \label{fig:Granule}
    \end{center}
\end{figure}
