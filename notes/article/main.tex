...
\begin{figure}[htbp]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{figs/A2.eps}
        \includegraphics[width=0.7\textwidth]{figs/A4.eps}
...
\begin{figure}[htbp]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{figs/B2.eps}
        \includegraphics[width=0.7\textwidth]{figs/B4.eps}
        \caption{Steady-state velocity $\cU$ as a function of the electric field magnitude $\beta$,
        for $\gamma < 1$.}
        \label{fig:NumResB}
    \end{center}
...
\begin{figure}[htbp]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{figs/D1n.eps}
        \includegraphics[width=0.7\textwidth]{figs/D1a.eps}
...
\begin{figure}[htbp]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{figs/D2n.eps}
        \includegraphics[width=0.7\textwidth]{figs/D2a.eps}
        \caption{Streamlines of the flow for various electric field values: numerical results (left)
        and analytical approximation (right).}
        \label{fig:NumResD}
    \end{center}
...
\begin{figure}[htbp]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{figs/D3n.eps}
        \includegraphics[width=0.7\textwidth]{figs/D3a.eps}
        \caption{Streamlines of the flow for various electric field values: numerical results (left)
        and analytical approximation (right).}
        \label{fig:NumResE}
    \end{center}
