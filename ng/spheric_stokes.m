...
I = find(gridVx.I);
% -2Vr / r^2
Lv_x1 = sparse(1:numel(I), I, ...
    -2./gridVx.X(I).^2, numel(I), gridVx.numel);

Lv_x2 = sparse(1:numel(I), 1:numel(I), ...
    -2./( sin(gridVx.Y(I)) .* gridVx.X(I).^2 )) * ...
...
Lv_y1 = -sparse(1:numel(I), I, ...
    1./( gridVy.X(I) .* sin(gridVy.Y(I)) ).^2, numel(I), gridVy.numel);

Lv_y2 = sparse(1:numel(I), 1:numel(I), 2./gridVy.X(I).^2) * ...
